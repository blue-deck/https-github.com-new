        ...
        <div className="bd-page-frame mx-auto w-full max-w-7xl px-5 pb-12 pt-5 sm:px-8 lg:px-[2.625rem] lg:pb-14">
          <section
            ...
            >
              ...
              >
                <CrewKeywordSearchField
                  inputId="crew-keyword-search"
                  language={language}
                  value={draftFilters.query}
                  onChange={(value) => setDraftFilter("query", value)}
                  onKeywordSearch={submitCrewKeywordSearch}
                />
                <CrewPositionSearchField
                  language={language}

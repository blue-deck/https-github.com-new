...
export const checklistTemplates: ChecklistTemplate[] = [
  ...
  },
  {
    ...
    type: "Anchoring",
    frequency: "One-time",
    summary: "Deck coordination for anchoring and anchor recovery.",
    tasks: [
  ...
  },
  {
    ...
    tasks: [
      ...
      "Engineer-to-captain communication tested",
...
export const checklistLibraryPacks: ChecklistLibraryPack[] = [
  {
    ...
    subtitle: "Deck, command and machinery checks before the yacht moves.",
...
const supplementalChecklistTasks: Array<{ categoryId: string; task: string }> = [
  ...
  { categoryId: "guest", task: "Confirm guest movement plan with captain and deck team" },

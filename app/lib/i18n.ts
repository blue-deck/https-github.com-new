...
import { jobsPhraseTranslations } from "./jobsPhraseTranslations";
...
const en = {
  ...
  "topbar.findJobs": "Find Jobs",
  "topbar.applications": "Applications",
  "topbar.hiring": "Hiring Desk",
  ...
  "nav.jobs": "Jobs",
  "nav.forCrew": "For Crew",
  "nav.hireCrew": "Hire Crew",
  "nav.yachtOperations": "Yacht Operations",
  ...
  "auth.signUp": "Sign up",
  "footer.description":
    "BlueDeck connects professional yacht jobs, crew careers and employer hiring with the yacht operations that begin after a successful hire.",
  ...
  "home.jobsEyebrow": "BlueDeck Jobs + YACHT-OS",
  "home.jobsTitle1": "Find your next yacht role.",
  "home.jobsTitle2": "Build the career behind it.",
  "home.jobsIntro":
    "Discover professional yacht opportunities, apply with one trusted crew profile and move from hiring to onboard operations without starting over.",
  "home.searchRole": "Position or keyword",
  "home.searchRolePlaceholder": "Deckhand, Captain, Stewardess...",
  "home.searchLocation": "Location",
  "home.searchLocationPlaceholder": "Mediterranean, Florida, worldwide...",
  "home.searchContract": "Contract",
  "home.searchAllContracts": "All contract types",
  "home.searchJobs": "Search jobs",
  "home.trustApply": "Free for crew to apply",
  "home.trustProfile": "One professional crew profile",
  "home.trustOnboard": "Hiring connected to YACHT-OS",
  "home.latestEyebrow": "Live opportunities",
  "home.latestTitle": "Professional yacht roles, clearly presented.",
  "home.latestIntro":
    "Every listing follows a structured format for position, vessel, contract, location, dates and requirements.",
  "home.browseAllJobs": "Browse all jobs",
  "home.categoriesEyebrow": "Explore by department",
  "home.categoriesTitle": "Start with the work you do best.",
  "home.categoryDeck": "Deck",
  "home.categoryInterior": "Interior",
  "home.categoryEngineering": "Engineering",
  "home.categoryGalley": "Galley",
  "home.categoryLeadership": "Command",
  "home.categoryShore": "Shore-based",
  "home.forCrewEyebrow": "For crew",
  "home.forCrewTitle": "Your profile becomes your career command centre.",
  "home.forCrewText":
    "Keep experience, documents, availability, applications, contracts and onboard access connected to one BlueDeck identity.",
  "home.forEmployersEyebrow": "For yachts and employers",
  "home.forEmployersTitle": "Recruit professionally, then onboard without duplicate work.",
  "home.forEmployersText":
    "Create structured vacancies, review applicants and connect the successful hire to invitations, contracts, documents and checklists.",
  "home.learnCrew": "Explore the crew experience",
  "home.learnHiring": "See the hiring workflow",
  "home.workflowEyebrow": "One connected workflow",
  "home.workflowTitle": "From opportunity to operational readiness.",
  "home.workflow1": "Publish a structured role",
  "home.workflow2": "Apply with a complete crew profile",
  "home.workflow3": "Review and shortlist candidates",
  "home.workflow4": "Make the offer and confirm the hire",
  "home.workflow5": "Invite crew to the yacht",
  "home.workflow6": "Open contracts and onboarding checklists",
  "home.yachtOsEyebrow": "Everything you already use stays connected",
  "home.yachtOsTitle": "Jobs first. Full yacht operations behind every successful hire.",
  "home.yachtOsIntro":
    "BlueDeck keeps its crew profiles, CVs, document control, contracts, yacht invitations, checklists, IMO crew lists and operational records.",
  "home.finalEyebrow": "Build your BlueDeck",
  "home.finalTitle": "Find the right role—or the right crew—inside one professional platform.",
  ...
  "login.heroTitle": "Yacht careers, hiring and onboard operations in one secure account.",
  "login.bullet1": "Professional crew profile and job applications",
  "login.bullet2": "Employer hiring desk and candidate pipeline",
  "login.bullet3": "Yacht invitations, contracts, documents and checklists",
...
const tr: Record<TranslationKey, string> = {
  ...
  "topbar.findJobs": "İş İlanları",
  "topbar.applications": "Başvurularım",
  "topbar.hiring": "İşe Alım Merkezi",
  "topbar.language": "Dil",
  ...
  "nav.forCrew": "Mürettebat İçin",
  "nav.hireCrew": "Mürettebat Bul",
  "nav.yachtOperations": "Yat Operasyonları",
  "nav.postJob": "İlan Ver",
  "nav.yachts": "Yatlar",
  ...
  "footer.description":
    "BlueDeck profesyonel yat işlerini, mürettebat kariyerini ve işveren işe alımını başarılı bir işe alımdan sonra başlayan yat operasyonlarıyla birleştirir.",
  ...
  "home.jobsEyebrow": "BlueDeck Jobs + YACHT-OS",
  "home.jobsTitle1": "Sıradaki yat işinizi bulun.",
  "home.jobsTitle2": "Kariyerinizi arkasında büyütün.",
  "home.jobsIntro":
    "Profesyonel yat fırsatlarını keşfedin, tek bir güvenilir mürettebat profiliyle başvurun ve işe alımdan onboard operasyonlarına yeniden başlamadan geçin.",
  "home.searchRole": "Pozisyon veya anahtar kelime",
  "home.searchRolePlaceholder": "Gemici, Kaptan, Hostes...",
  "home.searchLocation": "Konum",
  "home.searchLocationPlaceholder": "Akdeniz, Florida, dünya geneli...",
  "home.searchContract": "Kontrat",
  "home.searchAllContracts": "Tüm kontrat türleri",
  "home.searchJobs": "İlan ara",
  "home.trustApply": "Mürettebat için başvuru ücretsiz",
  "home.trustProfile": "Tek profesyonel mürettebat profili",
  "home.trustOnboard": "İşe alım YACHT-OS ile bağlantılı",
  "home.latestEyebrow": "Canlı fırsatlar",
  "home.latestTitle": "Profesyonel yat işleri, açık ve düzenli biçimde.",
  "home.latestIntro":
    "Her ilan pozisyon, yat, kontrat, konum, tarihler ve gereksinimler için yapılandırılmış bir düzen kullanır.",
  "home.browseAllJobs": "Tüm ilanları görüntüle",
  "home.categoriesEyebrow": "Departmana göre keşfet",
  "home.categoriesTitle": "En iyi yaptığınız işle başlayın.",
  "home.categoryDeck": "Güverte",
  "home.categoryInterior": "İç Hizmetler",
  "home.categoryEngineering": "Mühendislik",
  "home.categoryGalley": "Mutfak",
  "home.categoryLeadership": "Komuta",
  "home.categoryShore": "Kara Pozisyonları",
  "home.forCrewEyebrow": "Mürettebat için",
  "home.forCrewTitle": "Profiliniz kariyer komuta merkezinize dönüşür.",
  "home.forCrewText":
    "Deneyiminizi, belgelerinizi, uygunluğunuzu, başvurularınızı, kontratlarınızı ve onboard erişiminizi tek BlueDeck kimliğinde bağlı tutun.",
  "home.forEmployersEyebrow": "Yatlar ve işverenler için",
  "home.forEmployersTitle": "Profesyonel işe alım yapın, tekrar veri girmeden onboard edin.",
  "home.forEmployersText":
    "Yapılandırılmış ilanlar oluşturun, adayları değerlendirin ve başarılı işe alımı davet, kontrat, belge ve checklist akışına bağlayın.",
  "home.learnCrew": "Mürettebat deneyimini keşfet",
  "home.learnHiring": "İşe alım akışını incele",
  "home.workflowEyebrow": "Tek bağlantılı akış",
  "home.workflowTitle": "Fırsattan operasyonel hazırlığa.",
  "home.workflow1": "Yapılandırılmış ilanı yayınlayın",
  "home.workflow2": "Eksiksiz mürettebat profiliyle başvurun",
  "home.workflow3": "Adayları inceleyip kısa listeye alın",
  "home.workflow4": "Teklif verip işe alımı kesinleştirin",
  "home.workflow5": "Mürettebatı yata davet edin",
  "home.workflow6": "Kontrat ve onboarding checklistlerini açın",
  "home.yachtOsEyebrow": "Kullandığınız her şey bağlı kalır",
  "home.yachtOsTitle": "Önce işler. Her başarılı işe alımın arkasında tam yat operasyonu.",
  "home.yachtOsIntro":
    "BlueDeck; mürettebat profilleri, CV'ler, belge kontrolü, kontratlar, yat davetleri, checklistler, IMO mürettebat listeleri ve operasyon kayıtlarını korur.",
  "home.finalEyebrow": "BlueDeck'inizi oluşturun",
  "home.finalTitle": "Doğru işi veya doğru mürettebatı tek profesyonel platformda bulun.",
  ...
  "login.heroEyebrow": "BlueDeck YACHT-OS",
  "login.heroTitle": "Yat kariyeri, işe alım ve onboard operasyonları tek güvenli hesapta.",
  "login.bullet1": "Profesyonel mürettebat profili ve iş başvuruları",
  "login.bullet2": "İşveren işe alım merkezi ve aday süreci",
  "login.bullet3": "Yat davetleri, kontratlar, belgeler ve checklistler",

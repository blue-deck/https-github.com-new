...
const manualPhraseTranslations: Record<string, Partial<Record<Language, string>>> = {
  ...
  "Find Crew visibility": { tr: "Find Crew görünürlüğü" },
  "Control how employers discover you": {
    tr: "İşverenlerin sizi nasıl bulacağını yönetin",
  },
  "Availability": { tr: "Müsaitlik" },
  "Available from": { tr: "Müsaitlik başlangıcı" },
  "Available now": { tr: "Hemen müsait" },
  "Available soon": { tr: "Yakında müsait" },
  "Open to offers": { tr: "Tekliflere açık" },
  "Currently employed": { tr: "Şu anda çalışıyor" },

  ...
  return (
    <main className="min-h-screen bg-[#020817] p-6 text-white">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-6 rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-pink-500/10 p-10">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <div className="mt-6 space-y-4">
              ...
              <button
                onClick={addRequest}
                className="w-full rounded-2xl bg-pink-400 py-4 font-bold text-black"
              >
                Add Guest Request
              </button>
            </div>
            ...
            {requests.map((request) => (
              ...
              >
                <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                  <div>
                    <p className="text-sm uppercase text-pink-300">

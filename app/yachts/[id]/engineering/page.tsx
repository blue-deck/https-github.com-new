      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {assets.map((asset, index) => {
            ...
            return (
              <div key={asset.id} className="bd-app-card rounded-[36px] border border-white/10 bg-white/5 p-8">
        ...
        <div className="bd-app-card mt-10 rounded-[36px] border border-white/10 bg-white/5 p-8">
          <h2 className="text-4xl font-black">Maintenance Schedule</h2>
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {schedules.map((item) => (
              <div key={item.id} className="bd-app-card rounded-3xl border border-white/10 bg-black/20 p-5">

                  ...
                  <div className="border-t border-slate-200 pt-5 lg:col-span-2">
                    ...
                    <div className="mt-5">
                      <fieldset className="min-w-0">
                        ...
                        <div className="mt-2 flex min-h-12 min-w-0 flex-wrap overflow-hidden rounded-xl border border-slate-200 bg-white transition focus-within:border-cyan-500 focus-within:ring-2 focus-within:ring-cyan-100 has-[input:disabled]:cursor-not-allowed has-[input:disabled]:bg-slate-100 has-[input:disabled]:opacity-65 sm:flex-nowrap">
                          <input
                            type="text"
                            inputMode="numeric"
                            pattern="[0-9.]*"
                            ...
                            disabled={saving}
                            required
                            className="min-h-12 min-w-0 basis-full border-b border-slate-200 bg-transparent px-3 text-sm font-semibold tabular-nums text-slate-950 outline-none placeholder:text-slate-400 focus-visible:bg-cyan-50/60 focus-visible:shadow-[inset_0_0_0_2px_#06b6d4] disabled:cursor-not-allowed sm:flex-1 sm:basis-0 sm:border-b-0 sm:px-4"
                          />
                          <select
                            ...
                            disabled={saving}
                            className="min-h-12 min-w-0 flex-[1.3] border-slate-200 bg-slate-50 px-2 text-sm font-black text-slate-800 outline-none focus-visible:bg-cyan-50 focus-visible:shadow-[inset_0_0_0_2px_#06b6d4] disabled:cursor-not-allowed sm:flex-none sm:border-l sm:px-3"
                          >
                          ...
                          <select
                            ...
                            disabled={saving}
                            className="min-h-12 min-w-0 flex-1 border-l border-slate-200 bg-slate-50 px-2 text-sm font-black text-slate-800 outline-none focus-visible:bg-cyan-50 focus-visible:shadow-[inset_0_0_0_2px_#06b6d4] disabled:cursor-not-allowed sm:flex-none sm:px-3"
                          >
...
const inputClass =
  "bd-focus mt-1.5 min-h-12 w-full min-w-0 max-w-full rounded-xl border border-slate-200 bg-white px-3.5 text-sm font-semibold text-slate-950 transition placeholder:text-slate-400 hover:border-slate-300 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:opacity-65";
  ...
  return (
    <section className="min-w-0 rounded-2xl border border-slate-200 bg-white p-4 sm:p-6">
      <div className="mb-5 flex items-center gap-2.5">
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-cyan-50 text-cyan-800 [&>svg]:h-4 [&>svg]:w-4">
          {icon}
        </span>
        <h3 className="min-w-0 text-base font-black text-slate-950 [overflow-wrap:anywhere] sm:text-lg">{title}</h3>
      </div>
      {children}
    </section>
  );
  ...
  return (
    <div className="min-w-0 py-4 first:pt-0 last:pb-0">
      <button
        ...
        disabled={disabled}
        className="bd-focus flex min-h-14 w-full min-w-0 flex-col items-stretch gap-3 rounded-xl px-3 py-2.5 text-left transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-65 sm:flex-row sm:items-center sm:justify-between"
      >
        ...
        <div className="mt-1 flex flex-wrap gap-1.5 px-3 pb-1">
          {value.map((item) => (
            <button
              ...
              className="inline-flex min-h-11 min-w-0 max-w-full items-center gap-2 rounded-2xl bg-cyan-50 px-2.5 py-1.5 text-left text-xs font-semibold text-[#173f4a] transition hover:bg-rose-50 hover:text-rose-700 disabled:cursor-not-allowed disabled:opacity-65"
            >
              <span data-i18n-ignore className="min-w-0 whitespace-normal [overflow-wrap:anywhere]">
      ...
      {open ? (
        <div className="mt-2 min-w-0 max-w-full max-h-[min(55vh,28rem)] overflow-y-auto overscroll-contain rounded-xl bg-slate-50 p-2.5">
            ...
            {options.map((option) => {
              ...
              return (
                <button
                  ...
                  data-i18n-ignore
                  className={`min-h-11 min-w-0 max-w-full whitespace-normal rounded-lg border px-3 py-2.5 text-left text-sm font-semibold [overflow-wrap:anywhere] transition ${
                    selected
